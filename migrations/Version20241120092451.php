 ...
 */
final class Version20241120092451 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fight (id INT AUTO_INCREMENT NOT NULL, team_host_id INT NOT NULL, team_guest_id INT NOT NULL, INDEX IDX_21AA4456E0C1A0B2 (team_host_id), INDEX IDX_21AA445622087A26 (team_guest_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE score (id INT AUTO_INCREMENT NOT NULL, fight_id INT NOT NULL, team_id INT NOT NULL, points INT NOT NULL, INDEX IDX_32993751AC6657E4 (fight_id), INDEX IDX_32993751296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
